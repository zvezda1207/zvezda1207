...
Python-разработчик, специализируюсь на backend-разработке и создании прикладных инструментов автоматизации.

Разрабатываю REST API, работаю с базами данных и Docker, создаю внутренние инструменты для упрощения и автоматизации бизнес-процессов. Также разрабатываю Telegram-ботов и интеграции с внешними API.
...
Решает задачу сопоставления товаров из нескольких Excel-файлов с приоритетом по артикулу и нормализацией наименований. Формирует итоговый файл с подсветкой минимальной цены.
...
💡 В настоящее время развиваюсь в направлении backend-архитектуры, автоматизации процессов и интеграции систем.
